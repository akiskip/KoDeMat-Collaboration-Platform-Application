 ...
 */
public class DragPanelEditor implements IEditorPanel {

    NiftyGuiAppState guiAppState;
    private CommandController commandPanelController;

    public DragPanelEditor(Application visuClient) {
...
//                 here
        ...
        commandPanelController.setBasicEditor((VisuEditor)basicEditor);
