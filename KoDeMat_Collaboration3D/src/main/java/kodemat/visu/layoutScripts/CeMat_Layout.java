 ...
 */
public class CeMat_Layout extends LayoutClientImpl {
    ...
    private VisuComponent kuka_Node;
    private VisuComponent kuka_model;
    private VisuComponent RF_Kreis_Node;
    private VisuComponent rf_kreis_model;
...
//        super.addImageAsFloor("Textures/Layout_PA-Halle.jpg");
      ...
      setNodeTranslation(foerderNode1, new VisuVector3f(12.66f, 0.0f,-12.88f));
        ...
        kuka_Node = this.createNode("kuka_Node");
          setNodeTranslation(RBG_Node, new VisuVector3f(2f, 0.0f, 10.2f));
          
         /*-----------------------------------------------------------*/
        RF_Kreis_Node = this.createNode("RF_Kreis_Node");
          setNodeTranslation(RF_Kreis_Node, new VisuVector3f(2f, 0.0f, 10.2f));

       rf_kreis_model = this.createModel("rf_kreis_model", "Models/flw/RF/RF_Kreis.j3o");
        this.addChildNode(rf_kreis_model.getId(), kuka_Node.getId());
        this.setNodeTranslation(rf_kreis_model, new VisuVector3f(0f, 0f, 0f));
        this.setNodeRotation(rf_kreis_model, new VisuRotation(0, 0, 0));
this.setNodeScale(rf_kreis_model, new VisuVector3f(1f, 1f, 1f));   
         /*-----------------------------------------------------------*/

        
//        halleModel = this.createModel("HalleModel", "Models/halle_fml_imvirell/halle_fml_imvirell.j3o",true);
...
kuka_model = this.createModel("KukaModel", "Models/kuka/kuka.j3o");
        this.addChildNode(kuka_model.getId(), kuka_Node.getId());
        this.setNodeTranslation(kuka_model, new VisuVector3f(0f, 0f, 0f));
        this.setNodeRotation(kuka_model, new VisuRotation(0, 0, 0));
this.setNodeScale(kuka_model, new VisuVector3f(1f, 1f, 1f));   
...
//this.setNodeScale(rbg, new VisuVector3f(1f, 1f, 1f));    
    ...
    public static void main(String[] args) {
        PA_LayoutClient1 tc = new PA_LayoutClient1();
