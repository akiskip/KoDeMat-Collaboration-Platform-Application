 ...
 */
public class NiftyGuiAppState extends AbstractAppState implements ScreenController {
    ...
    private NiftyGuiAppState.KeyListener keyListener = new NiftyGuiAppState.KeyListener();
    private InputManager inputManager;
    AppStateManager stateManager;
    NiftyGuiAppState.HudController hudController = new NiftyGuiAppState.HudController();
    private boolean atStart;

    public NiftyGuiAppState(Nifty nifty, boolean atStart) {
        this.nifty = nifty;
        this.atStart = atStart;
    }

    public NiftyGuiAppState(Nifty nifty) {
        this.nifty = nifty;
        this.atStart = true;
    }
...
//        nifty.setDebugOptionPanelColors(true);   
        ...
        if (atStart) {
            getNifty().fromXml("Interface/Nifty/AllScreens.xml", "hidden", this);
...
//        screen.layoutLayers();
    ...
    public NiftyGuiAppState.HudController getHudController() {
