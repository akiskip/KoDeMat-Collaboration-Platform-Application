 ...
 */
public class HistorySyncedTable<T,K> extends AbstractSyncedTable_Field {

    
    public HistorySyncedTable(IMap hazelcastMap, T ValuesType, String componentName)
    {
    ...
    public void setUpSwingTable(Object contentClassType) {
        ...
        String[] columnLabels = {"IDs", "Username", "Action"};
