...
public class ExportGEXF {
    ...
    public ExportGEXF(VisuHelper helper) {
        this.helper = helper;
        this.executeExport();
    }

    public void executeExport() {
        ComponentsList = helper.getAllComponents();
        EdgesList = helper.getAllEdges();
        gexfNodeMap = new HashMap<String, Node>();
        gexfEdgeList = new ArrayList<Edge>();
        this.initiateGraph();
        this.buildGraphNodes();
        this.buildGraphEdges();
        this.exportGraph_XML("CeMAT_Demo_Layout1.gexf");
...
//            for every edge in the list create the respective gexf edge by connecting the nodes
    ...
    public void exportGraph_XML(String filename) {
        IndentingStaxGraphWriter graphWriter = new IndentingStaxGraphWriter();
