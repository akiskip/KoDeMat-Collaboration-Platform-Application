 ...
 */
public class VisuScaleChange extends AbstractVisuAttributeChange<VisuVector3f> {
    
    private VisuVector3f vec;

    public VisuScaleChange() {
    }

    public VisuScaleChange(VisuVector3f vec, long id) {
        super(id);
        this.vec = vec;
    }
