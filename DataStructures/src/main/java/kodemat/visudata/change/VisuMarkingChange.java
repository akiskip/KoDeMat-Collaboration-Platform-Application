 ...
 */
public class VisuMarkingChange extends AbstractVisuAttributeChange<VisuMarking>{

    public VisuMarkingChange() {
    }

    public VisuMarkingChange(VisuMarking vm, long id) {
        super(id);
        this.vm = vm;
    }
    ...
    private VisuMarking vm;

    @Override
    public VisuMarking getValue() {
        return vm;
    }

    @Override
    public void setValue(VisuMarking t) {
        this.vm = t;
    }

    @Override
    public short getType() {
        return VisuChange.MARKING;
    }
