 ...
 */
public class VisuEdgeSourceChange extends AbstractVisuAttributeChange<Long> {
    
    private Long pid;

    public VisuEdgeSourceChange() {
    }

    public VisuEdgeSourceChange(Long pid, long id) {
        super(id);
        this.pid = pid;
    }
