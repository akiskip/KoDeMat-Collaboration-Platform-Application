 ...
 */
public class VisuUndoDelete extends AbstractVisuAttributeChange<VisuUndoDeleteData> {
    
    private VisuUndoDeleteData vudd;

    public VisuUndoDelete() {
    }

    public VisuUndoDelete(VisuUndoDeleteData vudd, long id) {
        super(id);
        this.vudd = vudd;
    }
    ...
    public void readData(ObjectDataInput di) throws IOException {
        super.readData(di);
        vudd = new VisuUndoDeleteData();
        vudd.readData(di);
    }
    
    @Override
    public short getType() {
        return VisuChange.UNDO_DELETE;
    }
