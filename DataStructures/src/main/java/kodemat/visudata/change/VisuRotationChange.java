 ...
 */
public class VisuRotationChange extends AbstractVisuAttributeChange<VisuRotation> {
    
    private VisuRotation rot;

    public VisuRotationChange() {
    }

    public VisuRotationChange(VisuRotation rot, long id) {
        super(id);
        this.rot = rot;
    }
    ...
    @Override
    public VisuRotation getValue() {
        return rot;
    }

    @Override
    public void setValue(VisuRotation t) {
        rot = t;
    }
    ...
    public void readData(ObjectDataInput di) throws IOException {
        super.readData(di);
        rot = new VisuRotation();
        rot.readData(di);
    }
    
    @Override
    public short getType() {
        return VisuChange.ROTATION;
    }
